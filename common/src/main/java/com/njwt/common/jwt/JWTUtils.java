...
public class JWTUtils {
    ...
    public static final int REDIS_ERRCODE_FAIL = 1007;//验证不通过
    ...
    public static String createJWT(String id,String iss, String subject, long ttlMillis) {
        ...
        if (ttlMillis >= 0) {
            ...
            System.err.println("token的生效时间："+now.toString());
            System.err.println("token的失效时间:"+expDate.toString());
    ...
    /**
     * describe: TODO
     * @param json token解密信息
     * @return  token解密对象
     * @author 邢晓峰
     * creat_date: 2018/10/26
     * creat_time: 12:51
     **/

    public static JWTSubject readValue(String json){
        try {
            return MAPPER.readValue(json,JWTSubject.class);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
